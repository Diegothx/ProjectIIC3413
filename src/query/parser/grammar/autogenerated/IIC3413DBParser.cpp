...
void iic3413dbparserParserInitialize() {
  ...
  auto staticData = std::make_unique<IIC3413DBParserStaticData>(
    ...
    std::vector<std::string>{
      ...
      "LIKE", "BETWEEN", "LIMIT", "OR", "SELECT", "STR", "TABLE", "VALUES", 
  ...
  static const int32_t serializedATNSegment[] = {
  	...
  	36,38,40,42,44,46,0,4,2,0,8,8,14,14,1,0,18,23,1,0,32,33,1,0,1,17,175,
  	...
  	57,5,3,0,0,57,58,5,15,0,0,58,59,3,42,21,0,59,60,5,30,0,0,60,65,3,10,5,
  	...
  	0,0,70,71,5,6,0,0,71,72,5,7,0,0,72,73,3,42,21,0,73,74,5,16,0,0,74,75,
  	...
  	11,1,0,0,0,96,97,7,0,0,0,97,13,1,0,0,0,98,100,5,13,0,0,99,101,5,4,0,0,
  	...
  	0,0,155,156,3,38,19,0,156,157,5,10,0,0,157,158,3,40,20,0,158,159,5,1,
